<template>
    <div v-loading="isLoading" style="min-height: 200px;">
        <el-space v-if="creditCards.length > 0" direction="vertical" fill size="large" style="width: 100%">
        ...
        <el-empty v-else-if="!isLoading" description="尚未配置信用卡金流">
...
const { creditCards, isLoading } = storeToRefs(creditCardsStore)
